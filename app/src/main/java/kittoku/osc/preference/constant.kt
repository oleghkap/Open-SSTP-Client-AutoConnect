...
internal enum class OscPrefKey {
    ...
    AUTO_CONNECT_MOBILE,
    AUTO_DISCONNECT_MOBILE,
    AUTO_CONNECT_WIFI_ALLOW,
...
internal val DEFAULT_BOOLEAN_MAP = mapOf(
    ...
    OscPrefKey.AUTO_DISCONNECT_MOBILE to false,
    OscPrefKey.AUTO_CONNECT_WIFI_ALLOW to false,
    OscPrefKey.AUTO_CONNECT_WIFI_DENY to false,
